...
class Aae_Bricks_Testimonial3 extends \Bricks\Element
{
    ...
    {
        return esc_html__('Modern Testimonial', 'bricksfly');
    }
    ...
    public function set_control_groups()
    {
        ...
        $this->control_groups['border_style'] = [
            'title' => esc_html__('Section Border', 'bricksfly'),
            'tab'   => 'style',
        ];
        ...
        $this->control_groups['section_title_style'] = [
            'title' => esc_html__('Section Title', 'bricksfly'),
            'tab'   => 'style',
        ];
    ...
    public function set_controls()
    {
        ...
        $this->controls['sectionTitle'] = [
            'group'   => 'content',
            'label'   => esc_html__('Section Title', 'bricksfly'),
            'type'    => 'textarea',
            'default' => esc_html__('MY CLIENTS SAY ME BEST ONE', 'bricksfly'),
        ];
        ...
        $this->controls['secTitlePadding'] = [
            'group' => 'section_title_style',
            'label' => esc_html__('Section Padding', 'bricksfly'),
            'type'  => 'dimensions',
