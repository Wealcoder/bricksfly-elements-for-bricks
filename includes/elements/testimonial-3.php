...
class Aae_Bricks_Testimonial3 extends \Bricks\Element
{
                    ...
                    <?php foreach ($settings['testimonials'] as $index => $item) : ?>
                        ...
                        <div class="swiper-slide">
                            <div class="slide">
                                ...
                                <?php if ($has_link) : ?>
                                    <a class="name" <?php echo $this->render_attributes("ts3-link-{$index}"); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
