...
class THEBRBRE_Bricks_Testimonial3 extends \Bricks\Element
{
    ...
    {
        return esc_html__('Modern Testimonial', 'the-bricksfly');
    }
    ...
    public function set_control_groups()
    {
        ...
        $this->control_groups['border_style'] = [
            'title' => esc_html__('Section Border', 'the-bricksfly'),
            'tab'   => 'style',
        ];
        ...
        $this->control_groups['section_title_style'] = [
            'title' => esc_html__('Section Title', 'the-bricksfly'),
            'tab'   => 'style',
        ];
        ...
        $this->control_groups['quote_style'] = [
            'title' => esc_html__('Quote', 'the-bricksfly'),
            'tab'   => 'style',
        ];
    }
    ...
    public function set_controls()
    {
        ...
        $this->controls['sectionTitle'] = [
            'group'   => 'content',
            'label'   => esc_html__('Section Title', 'the-bricksfly'),
            'type'    => 'textarea',
            'default' => esc_html__('MY CLIENTS SAY ME BEST ONE', 'the-bricksfly'),
        ];
        ...
        $this->controls['testimonials'] = [
            ...
            'default' => [
                [
                    'testimonialContent' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'the-bricksfly'),
                ...
                [
                    'testimonialContent' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'the-bricksfly'),
                    'testimonialName'    => esc_html__('Alice Brown', 'the-bricksfly'),
                    'testimonialJob'     => esc_html__('Director', 'the-bricksfly'),
                ],
                [
                    'testimonialContent' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'the-bricksfly'),
                    'testimonialName'    => esc_html__('Tom Davis', 'the-bricksfly'),
                    'testimonialJob'     => esc_html__('Engineer', 'the-bricksfly'),
                ],
            ],
        ];
        ...
        $this->controls['quoteIcon'] = [
            'group'   => 'content',
            'label'   => esc_html__('Quote Icon', 'the-bricksfly'),
            'type'    => 'icon',
            'default' => [
                'library' => 'fontawesome',
        ...
        $this->controls['sliderDirection'] = [
            ...
            'type'    => 'select',
            'options' => [
                'ltr' => esc_html__('Left to Right', 'the-bricksfly'),
                'rtl' => esc_html__('Right to Left', 'the-bricksfly'),
            ],
            'default' => 'ltr',
            'inline'  => true,
        ];
        ...
        $this->controls['dotsSize'] = [
            'group' => 'navigation_style',
            'label' => esc_html__('Dot Size', 'the-bricksfly'),
            'type'  => 'slider',
        ...
        $this->controls['dotsColor'] = [
            'group' => 'navigation_style',
            'label' => esc_html__('Dot Color', 'the-bricksfly'),
            'type'  => 'color',
        ...
        $this->controls['dotsActiveColor'] = [
            'group' => 'navigation_style',
            'label' => esc_html__('Dot Active Color', 'the-bricksfly'),
            'type'  => 'color',
        ...
        $this->controls['secTitlePadding'] = [
            'group' => 'section_title_style',
            'label' => esc_html__('Section Padding', 'the-bricksfly'),
            'type'  => 'dimensions',
        ...
        $this->controls['quoteColor'] = [
            'group' => 'quote_style',
            'label' => esc_html__('Quote Color', 'the-bricksfly'),
            'type'  => 'color',
            'css'   => [
        ...
        $this->controls['quoteSize'] = [
            'group' => 'quote_style',
            'label' => esc_html__('Quote Size', 'the-bricksfly'),
            'type'  => 'number',
            'units' => true,
            'css'   => [
    ...
    public function enqueue_scripts()
    {
        ...
        $css_file = THEBRBRE_PATH . 'public/build/elements/testimonial-3.css';
        wp_enqueue_style(
            'aae-testimonial-3',
            THEBRBRE_URL . 'public/build/elements/testimonial-3.css',
            ['bricks-swiper'],
            file_exists($css_file) ? filemtime($css_file) : THEBRBRE_VERSION
        );

        $js_file = THEBRBRE_PATH . 'public/build/elements/testimonial-3.js';
        wp_enqueue_script(
            'aae-testimonial-3',
            THEBRBRE_URL . 'public/build/elements/testimonial-3.js',
            ['bricks-swiper'],
    ...
    public function render()
    {
        ...
        if (empty($settings['testimonials'])) {
            return $this->render_element_placeholder([
                ...
                'text'       => esc_html__('No testimonials added.', 'the-bricksfly'),
            ]);
        }
