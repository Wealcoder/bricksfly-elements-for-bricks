...
class AAB_Bricks_Progressbar extends \Bricks\Element
{
	...
	{
		return esc_html__('Progress Bar', 'bricksfly');
	}
	...
	public function set_control_groups()
	{
		$this->control_groups['progressbar'] = [
			'title' => esc_html__('Progress Bar', 'bricksfly'),
			'tab'   => 'content',
		];
		...
		$this->control_groups['percentage_style'] = [
			'title'    => esc_html__('Percentage', 'bricksfly'),
			'tab'      => 'style',
	...
	public function set_controls()
	{
		...
		$this->controls['element_list'] = [
			...
			'default' => '1',
			'options' => [
				'1' => esc_html__('Line', 'bricksfly'),
				'2' => esc_html__('Circle', 'bricksfly'),
				'3' => esc_html__('Dots', 'bricksfly'),
			],
			'inline'  => true,
		];
		...
		$this->controls['percentage'] = [
			'group'   => 'progressbar',
			'label'   => esc_html__('Percentage', 'bricksfly'),
			'type'    => 'number',
			'min'     => 0,
			'max'     => 100,
			'step'    => 1,
		...
		$this->controls['display_percentage'] = [
			'group'    => 'progressbar',
			'label'    => esc_html__('Display Percentage', 'bricksfly'),
			'type'     => 'checkbox',
			'default'  => true,
		...
		$this->controls['stroke_width'] = [
			'group'    => 'progressbar_style',
			'label'    => esc_html__('Stroke Width', 'bricksfly'),
			'type'     => 'number',
			'min'      => 0,
			'step'     => 0.1,
			'default'  => 2,
			'description' => esc_html__('Stroke width in em (line/circle).', 'bricksfly'),
			'required' => ['element_list', '!=', '3'],
		];

		$this->controls['trail_width'] = [
			'group'    => 'progressbar_style',
			'label'    => esc_html__('Trail Width', 'bricksfly'),
			'type'     => 'number',
			'min'      => 0,
			'step'     => 0.1,
			'default'  => 1,
			'description' => esc_html__('Trail width in em (line/circle).', 'bricksfly'),
			'required' => ['element_list', '!=', '3'],
		];
		...
		$this->controls['percentage_position'] = [
			'group'    => 'percentage_style',
			'label'    => esc_html__('Position Y', 'bricksfly'),
			'type'     => 'number',
			'unit'     => 'px',
			'step'     => 1,
			'default'  => -30,
