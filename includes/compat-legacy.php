...
if ( ! function_exists( 'aab_is_license_valid' ) && function_exists( 'thebrbre_is_license_valid' ) ) {
	function aab_is_license_valid() {
		return thebrbre_is_license_valid();
	}
}
if ( ! function_exists( 'aab_is_pro_installed' ) && function_exists( 'thebrbre_is_pro_installed' ) ) {
