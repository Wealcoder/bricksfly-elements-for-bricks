...
<div class="aab-review-notice" style="display:flex;align-items:center;gap:15px;padding:10px 0;">
    <div>
        <p style="font-size:14px;margin:0 0 10px;">
            <?php esc_html_e( 'Hey! We hope you are enjoying Bricksfly. Could you please do us a big favor and give us a 5-star rating on WordPress? It would help us spread the word!', 'the-bricksfly' ); ?>
        </p>
