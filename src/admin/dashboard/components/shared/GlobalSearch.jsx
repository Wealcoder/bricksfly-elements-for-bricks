...
import {
  ...
  generateElementSearchContent,
} from "@/lib/utils";
import { useExtensions, useTNavigation, useElements } from "@/hooks/app.hooks";
...
const GlobalSearch = ({ open, setOpen }) => {
  ...
  useEffect(() => {
    ...
    const elements = generateElementSearchContent(allElements?.elements);
    setPopularElements(elements?.items?.slice(0, 3));
