...
const CustomFontSettings = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      load_in_head: BRICKSFLY_ADDONS_ADMIN?.cf_settings?.load_in_head ?? false,
    },
  });
  ...
  async function onSubmit(data) {
    await fetch(BRICKSFLY_ADDONS_ADMIN.ajaxurl, {
      ...
      body: new URLSearchParams({
        action: "bricksfly_save_custom_font_settings",
      ...
      .then((return_content) => {
        ...
        BRICKSFLY_ADDONS_ADMIN.cf_settings = JSON.parse( return_content );
